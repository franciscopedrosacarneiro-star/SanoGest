...
<div>
    ...
    <main class="p-5 fundo-dashboard conteudo-principal">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="text-primary fw-bold mb-1">Bem-vindo ao SanoGest</h2>
                <p class="text-muted mb-0">
                    Painel interno de gestão do inventário hospitalar.
                </p>
            </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                <div class="card p-3 shadow-sm border-start border-danger border-5">
                    <h6 class="text-muted">Garantias Expiradas</h6>
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        <div class="alert alert-danger mb-2">
                            ...
                            5 equipamentos possuem garantia expirada.
                        </div>
                        <div class="alert alert-warning mb-2">
                            <i class="fa-solid fa-clock me-2"></i>
                            8 garantias terminam nos próximos 30 dias.
                        </div>
                        <div class="alert alert-secondary mb-0">
                            <i class="fa-solid fa-file-circle-exclamation me-2"></i>
                            12 equipamentos não possuem documentação associada.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td>EQP-001</td>
                            <td>Ventilador Dräger Evita V500</td>
                            <td>UCI</td>
                        ...
                        <tr>
                            <td>EQP-002</td>
                            <td>Monitor Multiparamétrico Philips MP5</td>
                            <td>Urgência</td>
                            <td><span class="badge bg-success">Ativo</span></td>
