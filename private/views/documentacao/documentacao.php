...
$documentos = listar_documentos($pdo);
$estatisticas = calcular_estatisticas_documentos($documentos);

$totalDocumentos = $estatisticas['total'];
$totalValidos = $estatisticas['validos'];
$totalATerminar = $estatisticas['a_terminar'];
$totalExpirados = $estatisticas['expirados'];
                    ...
                    <div class="card p-3 shadow-sm border-0 border-start border-primary border-5 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0"><?= htmlspecialchars($totalDocumentos) ?></h3>
                            </div>
                    ...
                    <div class="card p-3 shadow-sm border-0 border-start border-success border-5 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0"><?= htmlspecialchars($totalValidos) ?></h3>
                            </div>
                    ...
                    <div class="card p-3 shadow-sm border-0 border-start border-danger border-5 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0"><?= htmlspecialchars($totalExpirados) ?></h3>
                            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">
                        Documentação técnica e administrativa associada ao inventário
                    </small>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($documentos as $documento): ?>
                                    <tr 
                                        data-tipo="<?= htmlspecialchars($documento->tipo_documento ?? '') ?>" 
                                        data-estado="<?= htmlspecialchars($documento->estado ?? '') ?>" 
                                        data-associacao="<?= htmlspecialchars($documento->tipo_associacao ?? '') ?>"
                                    >
                                        <td>
                                        ...
                                        <td class="fw-bold">
                                            ...
                                            <?php if (!empty($documento->referencia)): ?>
                                                <br>
                                                <small class="text-muted">
                                                    Ref.: <?= htmlspecialchars($documento->referencia) ?>
                                                </small>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <a href="consultar.php?id_documento=<?= htmlspecialchars($documento->id_documento) ?>" 
                                            ...
                                            <?php if (!documento_expirado($documento)): ?>
                                                <a href="editar.php?id_documento=<?= htmlspecialchars($documento->id_documento) ?>" 
                                                   class="btn btn-sm btn-outline-warning" 
                                                   title="Editar">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>

                                                <a href="apagar.php?id_documento=<?= htmlspecialchars($documento->id_documento) ?>" 
                                                   class="btn btn-sm btn-outline-danger" 
                                                   title="Expirar">
                                                    <i class="fa-solid fa-ban"></i>
                                                </a>
                                            <?php else: ?>
                                                <button class="btn btn-sm btn-outline-secondary" disabled title="Documento expirado">
                                                    <i class="fa-solid fa-pen-slash"></i>
                                                </button>

                                                <button class="btn btn-sm btn-outline-secondary" disabled title="Já se encontra expirado">
                                                    <i class="fa-solid fa-ban"></i>
                                                </button>
                                            <?php endif; ?>
                                        </td>
                ...
                <div class="card-footer bg-white text-muted small">
                    Use a pesquisa ou os filtros para localizar rapidamente documentos por tipo, estado, associação ou entidade associada.
                </div>
            </div>
