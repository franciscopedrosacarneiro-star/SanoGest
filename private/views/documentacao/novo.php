...
<main class="p-5 fundo-dashboard conteudo-principal">
    <div class="bg-white bg-opacity-75 p-5 rounded shadow-sm">
        ...
        <form action="documentacao.html" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-text">Deixe em branco se não tiver validade.</div>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="entidade_associada" required>
                                <option value="">Selecione...</option>
                                <option>EQP-001 | Ventilador Pulmonar</option>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white fw-bold text-primary">
                    <i class="fa-solid fa-upload me-2"></i>3. Ficheiro
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            <label class="form-label fw-bold">Adicionar Ficheiro *</label>
                            <input 
                                type="file"
                                class="form-control"
                            ...
                            >
                            <div class="form-text">
                                Formatos permitidos: PDF Tamanho máximo: 10 MB.
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea 
                                ...
                                rows="4"
                                maxlength="500"
                                placeholder="Informações adicionais sobre o documento, validade, origem ou utilização."
                            ></textarea>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <a href="documentacao.html" class="btn btn-outline-secondary">
                    <i class="fa-solid fa-list me-2"></i>Ver Documentos
                </a>
