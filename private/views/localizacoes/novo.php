...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!validar_dados_localizacao($dados)) {
        ...
        try {
            $id_localizacao = criar_localizacao($pdo, $dados);
    ...
    <nav class="bg-white border-end shadow-sm sidebar-fixa">
        <div class="p-3">
            <ul class="nav nav-pills flex-column mb-auto">
                <li>
                    <a href="localizacoes.php" class="nav-link text-dark">
        ...
        <div class="bg-white bg-opacity-75 p-5 rounded shadow-sm">
            ...
            <form action="novo.php" method="POST" novalidate>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    ...
                    <div>
                        <a href="localizacoes.php" class="btn btn-secondary me-2">
                            Cancelar
                        </a>
