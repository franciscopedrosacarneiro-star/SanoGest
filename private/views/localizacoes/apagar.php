...
<head>
    ...
    <title>SanoGest | Apagar Localização</title>
...
<div>
    ...
    <main class="p-5 fundo-dashboard conteudo-principal">
        ...
        <h2 class="text-danger mb-3">Confirmar Remoção</h2>
           <p class="mb-4">
            Tem a certeza que pretende remover permanentemente a Localização <strong>[Localização]</strong>?<br>
            Esta ação é irreversível e irá remover todos os registos associados a este ativo.
           </p>
                 <div class="d-flex justify-content-center gap-3">
                <a href="localizacoes.html" class="btn btn-secondary px-4">Cancelar</a>
                <button type="submit" class="btn btn-danger px-4">Sim, Remover Localização</button>
            </div>
           </div>
        </div>
        </main>
