    ...
    <main class="p-5 fundo-dashboard conteudo-principal">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="text-primary fw-bold mb-1">
                    <i class="fa-solid fa-microchip me-2"></i>Lista de Equipamentos
                </h2>
                <p class="text-muted mb-0">
                    Consulta, pesquisa e gestão do inventário hospitalar de equipamentos médicos.
                </p>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-5">
                        <label for="pesquisaEquipamento" class="form-label fw-bold">Pesquisar</label>
                        <input 
                            type="text" 
                            id="pesquisaEquipamento" 
                            class="form-control" 
                            placeholder="Pesquisar por código, designação, marca, modelo ou nº série..."
                        >
                    </div>
                    ...
                    <div class="col-md-2">
                        <label for="filtroCriticidade" class="form-label fw-bold">Criticidade</label>
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <span class="fw-bold">
            <i class="fa-solid fa-list me-2 text-primary"></i>Equipamentos Registados
        </span>
        <small class="text-muted">Lista resumida do inventário</small>
    </div>
