...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!validar_dados_fornecedor($dados)) {
        ...
        try {
            $id_fornecedor = criar_fornecedor($pdo, $dados);
            ...
            <form id="formNovoFornecedor" action="novo.php" method="post" novalidate>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input 
                                        ...
                                        class="form-control" 
                                        name="morada" 
                                        placeholder="Ex: Rua da Saúde, nº 10, Porto"
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <textarea 
                                    ...
                                    rows="5"
                                    maxlength="500"
                                    placeholder="Notas internas sobre o fornecedor, contratos ou contacto."
                                ></textarea>
                            ...
                            <div class="alert alert-info">
                                ...
                                Confirme os dados antes de guardar o fornecedor.
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="reset" class="btn btn-outline-primary px-4" id="btnReporFornecedor">
                            <i class="fa-solid fa-rotate-left me-2"></i>Limpar
                        </button>

                        <button type="submit" class="btn btn-success px-4" id="btnGuardarFornecedor">
