...
<head>
    ...
    <title>SanoGest | Inativar Fornecedor</title>
    ...
    <main class="p-5 fundo-dashboard conteudo-principal">
        <div class="bg-white bg-opacity-75 p-5 rounded shadow-sm text-center">
            ...
            <p class="mb-4">
                ...
                <strong><?= htmlspecialchars($fornecedor->nome_empresa ?? '') ?></strong>?
                <br>
            ...
            <form method="post">
                <div class="d-flex justify-content-center gap-3">
                    <a href="consultar.php?id_fornecedor=<?= htmlspecialchars($fornecedor->id_fornecedor) ?>" class="btn btn-secondary px-4">
                        Cancelar
                    </a>

                    <button type="submit" class="btn btn-danger px-4">
                        Sim, Inativar Fornecedor
                    </button>
                </div>
            </form>
