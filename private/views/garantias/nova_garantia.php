...
<main class="p-5 fundo-dashboard conteudo-principal">
    <div class="bg-white bg-opacity-75 p-5 rounded shadow-sm">
        ...
        <form action="#" method="post" id="formNovaGarantia" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="id_equipamento" name="id_equipamento" class="form-select" required>
                                ...
                                <option value="1">EQP-001 | Ventilador V500</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="id_fornecedor" name="id_fornecedor" class="form-select" required>
                                ...
                                <option value="3">Dräger Portugal</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="numero_contrato" name="numero_contrato" class="form-control" placeholder="Ex: CON-2026-001" maxlength="40">
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" id="custo_anual" name="custo_anual" class="form-control" min="0" step="0.01" placeholder="Ex: 1250.00">
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="pessoa_contacto" name="pessoa_contacto" class="form-control" placeholder="Ex: Ana Martins" maxlength="80">
                        </div>

                        <div class="col-md-6">
                            <label for="telefone_contacto" class="form-label fw-bold">Telefone de contacto</label>
                            <input type="tel" id="telefone_contacto" name="telefone_contacto" class="form-control" placeholder="Ex: 210000000" maxlength="20">
                        </div>

                        <div class="col-md-6">
                            <label for="documento_associado" class="form-label fw-bold">Nome do documento</label>
                            <input type="text" id="documento_associado" name="documento_associado" class="form-control" placeholder="Ex: contrato_eqp001.pdf" maxlength="120">
                        </div>

                        <div class="col-md-6">
                            <label for="ficheiro_contrato" class="form-label fw-bold">Anexar ficheiro</label>
                            <input type="file" id="ficheiro_contrato" name="ficheiro_contrato" class="form-control" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                            <small class="text-muted">Formatos aceites: PDF, DOC, DOCX, JPG e PNG.</small>
                        </div>

                        <div class="col-12">
                            <label for="observacoes" class="form-label fw-bold">Observações</label>
                            <textarea id="observacoes" name="observacoes" class="form-control" rows="4" placeholder="Notas adicionais sobre a garantia, condições de assistência, cobertura ou prazos..."></textarea>
                        </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fa-solid fa-floppy-disk me-2"></i>Guardar Garantia/Contrato
                </button>
            </div>
